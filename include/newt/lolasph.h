...
void x_y(double cphi[], double sphi[], double phi_o, double dph, int n){
float phi;
int i;
...
/*******************************************************************************
*	x_y_z() generates the zenith components for x, y, and z             *
...
void x_y_z(double sthet[], double cthet[], double the_o, double dth, int n){
double theta;
int i;
...
*        required input is the filename, time, and the angular arrays          *
*******************************************************************************/
...
/*******************************************************************************
*	I have included a circle around the star so that the edges 	       *
*		around the animation remain smooth.			       *
*******************************************************************************/			
